<?php
if (isset($_COOKIE['settings']) && ($settings = $_COOKIE['settings'])) {
...
<?php /*<html lang="en" manifest="cache.manifest">*/ ?>
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="js/jquery.ui/theme/jquery-ui-1.8.16.custom.css" type="text/css">

		<link rel="stylesheet" href="css/styles.css" type="text/css">
		<link rel="stylesheet" id="theme-styles" href="<?php echo !empty($settings['theme']) ? $settings['theme'] : 'css/colorfull.css'; ?>" type="text/css">
	</head>
	...
	<body>
		<header>
			...
			<button id="settings-button">About...</button>
		</header>
