  ...
  })(
    {
      1: [function (require, module, exports) {
        ...
        function openCache(e) {
          var n;
          return e && e.cache && (n = e.cache.name),
            n = n || globalOptions.cache.name,
            caches.open(n);
        }
        ...
        function cleanupCache(e, n, t) {
          var c = e.url,
            ...
            r = Date.now();
          return debug(
            "Updating LRU order for " + c + ". Max entries is " + u +
              ", max age is " + a,
          ),
            idbCacheExpiration.getDb(o).then(function (e) {
        ...
        function renameCache(e, n, t) {
          return debug("Renaming cache: [" + e + "] to [" + n + "]", t),
            caches["delete"](n).then(function () {
              return Promise.all([caches.open(e), caches.open(n)]).then(
                function (n) {
                  var t = n[0], c = n[1];
      ...
      4: [function (require, module, exports) {
        ...
        var url = new URL("./", self.location),
          ...
          Route = function (e, t, i, s) {
            t instanceof RegExp
              ...
              : (0 !== t.indexOf("/") && (t = basePath + t),
                this.keys = [],
                this.regexp = pathRegexp(t, this.keys)),
              this.method = e,
              this.options = s,
              this.handler = i;
          };
        Route.prototype.makeHandler = function (e) {
          ...
          if (this.regexp) {
            ...
            t = {},
              this.keys.forEach(function (e, s) {
                t[e.name] = i[s + 1];
              });
          }
          return function (e) {
      ...
      5: [function (require, module, exports) {
        ...
        ["get", "post", "put", "delete", "head", "any"].forEach(function (e) {
          ...
          Router.prototype.add = function (e, t, r, o) {
            ...
            t instanceof RegExp
              ? n = RegExp
              : (n = o.origin || self.location.origin,
                n = n instanceof RegExp ? n.source : regexEscape(n)),
              e = e.toLowerCase();
          ...
          Router.prototype.matchMethod = function (e, t) {
            ...
            return this._match(e, keyMatch(this.routes, o), n) ||
          ...
          Router.prototype.match = function (e) {
            return this.matchMethod(e.method, e.url) ||
      ...
      6: [function (require, module, exports) {
        ...
        function cacheFirst(e, r, t) {
          return helpers.debug("Strategy: cache first [" + e.url + "]", t),
      ...
      7: [function (require, module, exports) {
        ...
        function cacheOnly(e, r, c) {
          return helpers.debug("Strategy: cache only [" + e.url + "]", c),
      ...
      8: [function (require, module, exports) {
        ...
        function fastest(e, n, t) {
          return helpers.debug("Strategy: fastest [" + e.url + "]", t),
            new Promise(function (r, s) {
                ...
                a = function (e) {
                  o.push(e.toString()),
                    c
                      ? s(
                        new Error(
                          'Both cache and network failed: "' + o.join('", "') +
                            '"',
                        ),
                      )
                      : c = !0;
              ...
              helpers.fetchAndCache(e.clone(), t).then(h, a),
                cacheOnly(e, n, t).then(h, a);
            });
        }
      ...
      10: [function (require, module, exports) {
        ...
        function networkFirst(e, r, t) {
          ...
          var s = t.successResponses || globalOptions.successResponses,
            n = t.networkTimeoutSeconds || globalOptions.networkTimeoutSeconds;
          return helpers.debug("Strategy: network first [" + e.url + "]", t),
            helpers.openCache(t).then(function (r) {
              var o, u, i = [];
              if (n) {
              ...
              var a = helpers.fetchAndCache(e, t).then(function (e) {
                ...
                return helpers.debug(
                  "Network or response error, fallback to cache [" + e.url +
                    "]",
                  t,
                ),
                  r.match(e).then(function (e) {
      ...
      11: [function (require, module, exports) {
        ...
        function networkOnly(e, r, t) {
          return helpers.debug("Strategy: network only [" + e.url + "]", t),
            fetch(e);
        }
        var helpers = require("../helpers");
      ...
      12: [function (require, module, exports) {
        ...
        function precache(e) {
          e instanceof Promise || validatePrecacheInput(e),
            options.preCacheItems = options.preCacheItems.concat(e);
        }
        ...
        self.addEventListener("install", function (e) {
          ...
          helpers.debug("install event fired"),
            helpers.debug("creating cache [" + t + "]"),
            e.waitUntil(
              helpers.openCache({ cache: { name: t } }).then(function (e) {
                return Promise.all(options.preCacheItems).then(flatten).then(
                  validatePrecacheInput,
                ).then(function (t) {
                  return helpers.debug(
          ...
          self.addEventListener("fetch", function (e) {
            ...
            t
              ...
              : router["default"] && "GET" === e.request.method &&
      ...
      14: [function (require, module, exports) {
        function parse(e) {
          for (
            ...
            if (a += e.slice(o, s), o = s + p.length, i) a += i[1];
            else {
              var c = e[o],
                u = t[2],
                l = t[3],
          ...
          return function (r, n) {
            for (
              var o = "",
                a = r || {},
                p = n || {},
                i = p.pretty ? encodeURIComponentPretty : encodeURIComponent,
                s = 0;
              s < e.length;
              s++
            ) {
              ...
              if ("string" != typeof c) {
                ...
                if (isarray(l)) {
                  ...
                  if (
                    u = c.asterisk ? encodeAsterisk(l) : i(l), !t[s].test(u)
                  ) {
                    throw new TypeError(
                      'Expected "' + c.name + '" to match "' + c.pattern +
                        '", but received "' + u + '"',
                    );
                  }
                  o += c.prefix + u;
        ...
        function stringToRegexp(e, t, r) {
          for (
            var n = parse(e), o = tokensToRegExp(n, r), a = 0;
            a < n.length;
            a++
          ) {
        ...
        function tokensToRegExp(e, t) {
          ...
          return r || (o = (p ? o.slice(0, -2) : o) + "(?:\\/(?=$))?"),
            o += n ? "$" : r && p ? "" : "(?=\\/|$)",
            new RegExp("^" + o, flags(t));
        }
      ...
      15: [function (require, module, exports) {
        !function () {
          ...
          t &&
              (!e || "Firefox" === r && n >= 46 || "Chrome" === r && n >= 50) ||
